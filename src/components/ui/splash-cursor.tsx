...
const FollowCursor: React.FC<FollowCursorProps> = ({ color = '#323232a6' }) => {
  useEffect(() => {
    ...
    const init = () => {
      ...
      // Tarayıcı imlecini gizlemek için CSS ekle
      document.body.style.cursor = 'none';  // Bu satır varsayılan imleci gizler
    ...
    const destroy = () => {
      ...
      // Tarayıcı imlecini geri getir
      document.body.style.cursor = ''; // İmleci geri getirir
    };
